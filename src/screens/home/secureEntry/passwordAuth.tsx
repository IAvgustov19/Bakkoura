...
import { Button, Text, TextInput, View, StyleSheet, Platform, SafeAreaView } from 'react-native';
...
import SignUpForm from '../../auth/SignUpScreen/components/SignUpForm';
  ...
  useEffect(() => {
    const fetch = async () => {
      try {
        ...
        const userData = await db.collection('users').where('id', '==', userId).get();
        if (!userData.empty) {
          console.log('useruseruseruserDatauserData', userData.docs[0].data().name);
          ...
          >
            ...
            <RN.ScrollView
              ...
              <RN.View style={styles.content}>
                ...
                <TextView title="Write your password to enter" textAlign="center" />
