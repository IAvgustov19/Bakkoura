export enum APP_ROUTES {
  ...
  PROJECT_TIMER_SLIDER = 'ProjectTimerSlider',
  WORLD_TIME = 'WorldTime',
  WORLD_SLIDER = 'WorldSlider',
  STOP_WATCH = 'StopWatch',
  STOP_WATCH_SLIDER = 'StopWatchSlider',
  ALARM_SCREEN = 'AlarmScreen',
  ALARM_SLIDER = 'AlarmSlider',
  EVENTS_SCREEN = 'EventScreen',
  EVENTS_SLIDER = 'EventSlider',
  ...
  BAKKOURA_SLIDER = 'BakkouraSlider',
